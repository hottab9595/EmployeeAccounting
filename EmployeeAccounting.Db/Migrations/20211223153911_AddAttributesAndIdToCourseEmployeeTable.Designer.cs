...
namespace EmployeeAccounting.Db.Migrations
{
    ...
    [Migration("20211223153911_AddAttributesAndIdToCourseEmployeeTable")]
    partial class AddAttributesAndIdToCourseEmployeeTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeAccounting.Db.Model.CourseEmployee", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EmployeeAccounting.Db.Model.CourseEmployee", b =>
                {
                    b.HasOne("EmployeeAccounting.Db.Model.Course", "Course")
                        .WithMany("CourseEmployees")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EmployeeAccounting.Db.Model.Employee", "Employee")
                        .WithMany("CourseEmployees")
